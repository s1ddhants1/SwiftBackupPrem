...
val versionMap = mapOf(
    ...
    620 to VersionClasses("defpackage.gn5", "defpackage.c64", "defpackage.d45", "defpackage.b45", "defpackage.uj", "defpackage.c90", "defpackage.hk", "defpackage.cu", "defpackage.gg3"),
)
